...
public class ST1614ATS108Newrolecreationforasecretary {
  ...
  @Test
  public void testST1614ATS108Newrolecreationforasecretary() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description -New role creation for a Secretary
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*NewRoleCreation2[\\s\\S]*$"));
    } catch (Error e) {
