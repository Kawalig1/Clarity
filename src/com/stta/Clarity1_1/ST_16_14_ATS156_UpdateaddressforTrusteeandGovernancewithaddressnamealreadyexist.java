...
public class ST1614ATS156UpdateaddressforTrusteeandGovernancewithaddressnamealreadyexist {
  ...
  @Test
  public void testST1614ATS156UpdateaddressforTrusteeandGovernancewithaddressnamealreadyexist() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description  - Update address for Trustee and Governance with address name already exist
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_TrusteeAddressDetailsView_txtAddressName")).sendKeys("TrusteeAddressC");
