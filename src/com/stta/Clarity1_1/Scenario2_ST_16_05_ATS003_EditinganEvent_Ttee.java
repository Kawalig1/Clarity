...
public class Scenario2ST1605ATS003EditinganEventTtee {
  ...
  @Test
  public void testScenario2ST1605ATS003EditinganEventTtee() throws Exception {
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder_EventFormView_TitleTextBox")).sendKeys("Trustee");
    ...
    driver.findElement(By.linkText("Trustee")).click();
