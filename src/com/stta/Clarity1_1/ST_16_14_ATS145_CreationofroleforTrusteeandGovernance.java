...
public class ST1614ATS145CreationofroleforTrusteeandGovernance {
  ...
  public void testST1614ATS145CreationofroleforTrusteeandGovernance() throws Exception {
    ...
    // Description  - Creation of role for Trustee and Governance
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_RoleDetailsView_RoleStringListBox")).sendKeys("GovernanceRole1_Crea");
