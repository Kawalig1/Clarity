...
public class ST1614ATS102Duplicatetrustcreation {
  ...
  @Test
  public void testST1614ATS102Duplicatetrustcreation() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description - Verify that admin with admin role is not able to duplicate Trust. 
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_TrustsDetailsView_DescriptionTextBox")).sendKeys("Duplicate");
    ...
    assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*A trust with the same name already exists\\. Please enter a different name\\.[\\s\\S]*$"));
