...
public class ST1614ATS195ForgotpasswordwithoutenteringmandatorydetailsNOLONGERAPPLICABLE {
  ...
  @Test
  public void testST1614ATS195ForgotpasswordwithoutenteringmandatorydetailsNOLONGERAPPLICABLE() throws Exception {
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder_ForgotPassword1_NewPasswordTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_ForgotPassword1_NewPasswordTextBox")).sendKeys("passwordaa");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_ForgotPassword1_ConfirmPasswordTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_ForgotPassword1_ConfirmPasswordTextBox")).sendKeys("passwordaa");
    // Warning: verifyTextPresent may require manual changes
    try {
