...
public class Scenario1ST1605ATS005Goveranceuseraddsanentry {
  ...
  @Test
  public void testScenario1ST1605ATS005Goveranceuseraddsanentry() throws Exception {
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder_EventFormView_TitleTextBox")).sendKeys("testauto");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_EventFormView_DescriptionTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_EventFormView_DescriptionTextBox")).sendKeys("C");
    new Select(driver.findElement(By.id("ctl00_ContentPlaceHolder_EventFormView_StartHoursDropDownList"))).selectByVisibleText("11");
    new Select(driver.findElement(By.id("ctl00_ContentPlaceHolder_EventFormView_EndHoursDropDownList"))).selectByVisibleText("13");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_EventFormView_InsertLinkButton")).click();
    driver.findElement(By.linkText("testauto")).click();
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*testauto[\\s\\S]*$"));
    } catch (Error e) {
