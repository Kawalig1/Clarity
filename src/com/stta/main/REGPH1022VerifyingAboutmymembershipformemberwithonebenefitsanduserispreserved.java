...
public class REGPH1022VerifyingAboutmymembershipformemberwithonebenefitsanduserispreserved {
  ...
  @Test
  public void testREGPH1022VerifyingAboutmymembershipformemberwithonebenefitsanduserispreserved() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Dynamic Pages - My Membership_08
    // Author: Harish , Date: 19/05/2008
    // Log in as Member With one scheme,two  Benefits - One preserved
    ...
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*01/01/1988[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Warning: verifyTextPresent may require manual changes
