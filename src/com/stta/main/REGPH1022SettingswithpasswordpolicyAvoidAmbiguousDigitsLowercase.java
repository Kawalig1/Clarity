...
public class REGPH1022SettingswithpasswordpolicyAvoidAmbiguousDigitsLowercase {
  ...
  @Test
  public void testREGPH1022SettingswithpasswordpolicyAvoidAmbiguousDigitsLowercase() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Setting the Numbers, lower-case in the password policy 
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]* Password incorrect or new password is invalid\\. Your new password should contain numbers, lower-case characters\\. It should be between 8 and 10 characters in length and it should be different from your previous password\\. [\\s\\S]*$"));
    } catch (Error e) {
