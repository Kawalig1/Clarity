...
public class REGPH1011SettingswithpasswordpolicyAvoidAmbiguousLowercase {
  ...
  @Test
  public void testREGPH1011SettingswithpasswordpolicyAvoidAmbiguousLowercase() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Checking only lower-case in the setting 
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_NewPasswordTextBox")).sendKeys("12");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_ConfirmNewPasswordTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_ConfirmNewPasswordTextBox")).sendKeys("12");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_ChangePasswordButton")).click();
    try {
      assertTrue(driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_CommentLabel")).getText().matches("^Password incorrect or new password is invalid\\. Your new password should contain numbers, one of the following symbols: ! @ # \\$ % & [\\s\\S]* + - = [\\s\\S] / ~\\. It should be between 8 and 10 characters in length and it should be different from your previous password\\.$"));
    } catch (Error e) {
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangeMemorableWordControl_MemorableWordTextBox")).sendKeys("12");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangeMemorableWordControl_ConfirmMemorableWordTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangeMemorableWordControl_ConfirmMemorableWordTextBox")).sendKeys("12");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangeMemorableWordControl_ChangeMemorableWordButton")).click();
    try {
      assertTrue(driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangeMemorableWordControl_CommentLabel")).getText().matches("^Password incorrect or new password is invalid\\. Your new password should contain numbers, one of the following symbols: ! @ # \\$ % & [\\s\\S]* + - = [\\s\\S] / ~\\. It should be between 8 and 10 characters in length and it should be different from your previous password\\.$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Password incorrect or new password is invalid\\.Your new password should contain numbers, one of the following symbols: ! @ # \\$ % & [\\s\\S]* + - = [\\s\\S] / ~\\. It should be between 8 and 10 characters in length and it should be different from your previous password\\.[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
