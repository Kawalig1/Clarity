...
public class REGPH1001CorrespondanceaddressChangebetweenEmployeeandEmployer {
  ...
  @Test
  public void testREGPH1001CorrespondanceaddressChangebetweenEmployeeandEmployer() throws Exception {
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Correspondence address[\\s\\S]*$"));
    } catch (Error e) {
    ...
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Personal Details[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
