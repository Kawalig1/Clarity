...
public class Ph1_003_active_to_inactive_1 {
	...
	private WebDriver driver;
	  ...
	  public void testREGPH1002AdminSiteFilterWithPaginationHtm() throws Exception {
	    ...
	    for (int second = 0;; second++) {
	    	if (second >= 60) fail("timeout");
	    	try { if (driver.findElement(By.xpath("//table[@id='ctl00_ContentPlaceHolder1_AdminContainer_FilterPanel_FilterGridView']/tbody/tr[2]/td[2]")).getText().matches("^[\\s\\S]*dynamic05[\\s\\S]*$")) break; } catch (Exception e) {}
	    ...
	    // Warning: verifyTextPresent may require manual changes
	   /* try {
	      assertTrue(driver.findElement(By.xpath("//table[@id='ctl00_ContentPlaceHolder1_AdminContainer_FilterPanel_FilterGridView']/tbody/tr[2]/td[2]")).getText().matches("^[\\s\\S]*dynamic05[\\s\\S]*$"));
	    } catch (Error e) {
	      verificationErrors.append(e.toString());
	    }*/
	    ...
	    driver.findElement(By.id("ctl00_backToHomePage")).click();
	    driver.findElement(By.id("ctl00_MenuTreeViewn3")).click();
	    driver.findElement(By.id("__tab_ctl00_ContentPlaceHolder1_AdminContainer_UserPanel")).click();
	    driver.findElement(By.id("ctl00_ContentPlaceHolder1_AdminContainer_FilterPanel_txtUserName")).clear();
	    Thread.sleep(1000);
