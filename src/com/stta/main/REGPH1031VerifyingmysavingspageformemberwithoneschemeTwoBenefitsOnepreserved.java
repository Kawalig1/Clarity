...
public class REGPH1031VerifyingmysavingspageformemberwithoneschemeTwoBenefitsOnepreserved {
  ...
  @Test
  public void testREGPH1031VerifyingmysavingspageformemberwithoneschemeTwoBenefitsOnepreserved() throws Exception {
    ...
    try {
      assertEquals(driver.findElement(By.cssSelector("#summaryBoxTotalConts > p.summaryBoxHeader")).getText(), "Total");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertEquals(driver.findElement(By.id("ctl00_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_totalConts")).getText(), "£0.00");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Equities fund[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Warning: verifyTextPresent may require manual changes
