...
public class REGPH1020SettingswithpasswordpolicyAvoidAmbiguousUppercaseSymbols {
  ...
  @Test
  public void testREGPH1020SettingswithpasswordpolicyAvoidAmbiguousUppercaseSymbols() throws Exception {
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]* Password incorrect or new password is invalid\\. Your new password should contain upper-case characters, one of the following symbols: ! @ # \\$ % & [\\s\\S]* + - = [\\s\\S] / ~\\. It should be between 8 and 10 characters in length and it should be different from your previous password\\. [\\s\\S]*$"));
    } catch (Error e) {
