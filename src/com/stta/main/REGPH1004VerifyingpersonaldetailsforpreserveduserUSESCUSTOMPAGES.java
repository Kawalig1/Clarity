...
public class REGPH1004VerifyingpersonaldetailsforpreserveduserUSESCUSTOMPAGES {
  ...
  @Test
  public void testREGPH1004VerifyingpersonaldetailsforpreserveduserUSESCUSTOMPAGES() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Personal Details of perserved member -OffshoreP1
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//tr[3]/td[2]")).getText(), "OffshorePreservedOne");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//tr[4]/td[2]")).getText(), "Tina OffshorePreservedOne");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//tr[5]/td[2]")).getText(), "28/11/1947 00:00:00");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//tr[6]/td[2]")).getText(), "AC282512A");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
