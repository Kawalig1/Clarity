...
public class REGPH1023SettingswithpasswordpolicyAvoidAmbiguousDigitsUppercase {
  ...
  @Test
  public void testREGPH1023SettingswithpasswordpolicyAvoidAmbiguousDigitsUppercase() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Setting the Numbers, upper-case in the password policy 
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]* Password incorrect or new password is invalid\\. Your new password should contain numbers, upper-case characters\\. It should be between 8 and 10 characters in length and it should be different from your previous password\\. [\\s\\S]*$"));
    } catch (Error e) {
