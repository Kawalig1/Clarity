...
public class REGPH1001Duplicatepasswordpolicycreation {
  ...
  @Test
  public void testREGPH1001Duplicatepasswordpolicycreation() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Auhor: Harish , Date:25/04/2008
    // Bulk Pin generation Scenario 5
    // Create a password policy Duplicate) with a name that already exists
    // Create a password policy with no name
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_AdminContainer_PasswordPolicyPanel_PasswordPolicyDetailsView_txtPasswordPolicyNameValue")).sendKeys("DuplicatePasswordPolicy");
    // ERROR: Caught exception [Error: locator strategy either id or name must be specified explicitly.]
    // ERROR: Caught exception [Error: locator strategy either id or name must be specified explicitly.]
    // ERROR: Caught exception [Error: locator strategy either id or name must be specified explicitly.]
    // ERROR: Caught exception [Error: locator strategy either id or name must be specified explicitly.]
