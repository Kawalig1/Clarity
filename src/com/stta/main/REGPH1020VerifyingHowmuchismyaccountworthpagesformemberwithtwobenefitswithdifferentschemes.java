...
public class REGPH1020VerifyingHowmuchismyaccountworthpagesformemberwithtwobenefitswithdifferentschemes {
  ...
  @Test
  public void testREGPH1020VerifyingHowmuchismyaccountworthpagesformemberwithtwobenefitswithdifferentschemes() throws Exception {
    ...
    try {
      assertEquals(driver.findElement(By.id("ctl00_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_FormView3_Label2")).getText(), "£145,000.00");
    } catch (Error e) {
