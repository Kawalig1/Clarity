...
public class REGPH1001GenerationofPINforanemployerbySuperadmin {
  ...
  @Test
  public void testREGPH1001GenerationofPINforanemployerbySuperadmin() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Employer and Superadmin Pin generation_01
    // Author : Harish , Date:27/05/2008
    // Generate Pin For an Employer
    // Log In to Superadmin site
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_LoginGenerationContainer_EmployerLoginGenerationPanel_AddEmployersGridView_ctl04_FooterTitleTextBox")).sendKeys("Ms");
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl00_ContentPlaceHolder1_AdminContainer_FilterPanel_FilterGridView']/tbody/tr[2]/td[3]")).getText(), "PG103");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
