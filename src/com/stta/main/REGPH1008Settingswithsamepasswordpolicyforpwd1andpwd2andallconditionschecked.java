...
public class REGPH1008Settingswithsamepasswordpolicyforpwd1andpwd2andallconditionschecked {
  ...
  @Test
  public void testREGPH1008Settingswithsamepasswordpolicyforpwd1andpwd2andallconditionschecked() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Global Setting 05 - User checked all the options 
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_NewPasswordTextBox")).sendKeys("pa");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_ConfirmNewPasswordTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_ConfirmNewPasswordTextBox")).sendKeys("pa");
