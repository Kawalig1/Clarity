...
public class REGPH1014SettingswithpasswordpolicyAvoidAmbiguousUppercaseLowercase {
  ...
  @Test
  public void testREGPH1014SettingswithpasswordpolicyAvoidAmbiguousUppercaseLowercase() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Checking only upper-case, lower-case in the setting 
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Password incorrect or new password is invalid\\.Your new password should contain lower-case characters, upper-case characters\\. It should be between 8 and 10 characters in length and it should be different from your previous password[\\s\\S]*$"));
    } catch (Error e) {
