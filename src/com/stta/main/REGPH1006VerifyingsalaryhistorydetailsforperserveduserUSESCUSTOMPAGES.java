...
public class REGPH1006VerifyingsalaryhistorydetailsforperserveduserUSESCUSTOMPAGES {
  ...
  @Test
  public void testREGPH1006VerifyingsalaryhistorydetailsforperserveduserUSESCUSTOMPAGES() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Salary history Details of Preserved User - OffshoreP1
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//div[4]/table/tbody/tr[1]/td[2]")).getText(), "12222");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//div[4]/table/tbody/tr[2]/td[2]")).getText(), "123456");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//tr[3]/td[2]")).getText(), "0");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//tr[4]/td[2]")).getText(), "11111");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
