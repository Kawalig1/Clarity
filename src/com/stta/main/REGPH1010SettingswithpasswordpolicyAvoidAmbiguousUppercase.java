...
public class REGPH1010SettingswithpasswordpolicyAvoidAmbiguousUppercase {
  ...
  @Test
  public void testREGPH1010SettingswithpasswordpolicyAvoidAmbiguousUppercase() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Checking only upper-case in the setting 
    ...
    try {
      assertEquals(driver.findElement(By.id("ctl00_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_ChangePassword1_CommentLabel")).getText(), "Password incorrect or new memorable word is invalid. Your new memorable word should contain numbers, upper-case characters. It should be between 8 and 10 characters in length");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
