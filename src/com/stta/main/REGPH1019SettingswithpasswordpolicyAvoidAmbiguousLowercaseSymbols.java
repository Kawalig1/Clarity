...
public class REGPH1019SettingswithpasswordpolicyAvoidAmbiguousLowercaseSymbols {
  ...
  @Test
  public void testREGPH1019SettingswithpasswordpolicyAvoidAmbiguousLowercaseSymbols() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Setting the lower-case, symbols in the password policy 
    ...
    new Select(driver.findElement(By.id("ctl00_ContentPlaceHolder1_AdminContainer_SettingsPanel_SettingsDetailsView_drpSettingsPassword1Policy"))).selectByVisibleText("Testing07");
    new Select(driver.findElement(By.id("ctl00_ContentPlaceHolder1_AdminContainer_SettingsPanel_SettingsDetailsView_drpSettingsPassword2Policy"))).selectByVisibleText("Testing07");
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_NewPasswordTextBox")).sendKeys("111");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_ConfirmNewPasswordTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_ConfirmNewPasswordTextBox")).sendKeys("111");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_ChangePasswordButton")).click();
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]* Password incorrect or new password is invalid\\. Your new password should contain lower-case characters, one of the following symbols: ! @ # \\$ % & [\\s\\S]* + - = [\\s\\S] / ~\\. It should be between 8 and 10 characters in length and it should be different from your previous password\\. [\\s\\S]*$"));
    } catch (Error e) {
    ...
    // Verifying the messages in the membersite 
