...
public class REGPH1040VerifyingWhatIpaidpageformemberwithtwobenefitssameschemes {
  ...
  @Test
  public void testREGPH1040VerifyingWhatIpaidpageformemberwithtwobenefitssameschemes() throws Exception {
    ...
    // LOgin as Member With Two Schemes, One benefit Each - Both Active
    ...
    driver.findElement(By.id("ctl00_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_StartDate")).sendKeys("01/01/2000");
    driver.findElement(By.id("ctl00_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_EndDate")).clear();
    driver.findElement(By.id("ctl00_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_EndDate")).sendKeys("16/07/2008");
    ...
    // ERROR: Caught exception [ERROR: Unsupported command [getTable | id=ctl00_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_grid_DXMainTable.2.1 | ]]
    // ERROR: Caught exception [ERROR: Unsupported command [getTable | id=ctl00_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_grid_DXMainTable.2.2 | ]]
    // ERROR: Caught exception [ERROR: Unsupported command [getTable | id=ctl00_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_grid_DXMainTable.2.3 | ]]
