...
public class REGPh1002Checkifthepagesaredisplayedasperconfigfileforactandpresmember {
  ...
  @Test
  public void testREGPh1002Checkifthepagesaredisplayedasperconfigfileforactandpresmember() throws Exception {
    ...
    try {
      assertEquals(driver.findElement(By.cssSelector("td.big2")).getText(), "RoleMatrix");
    } catch (Error e) {
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder_btnLogin")).click();
    try {
      assertEquals(driver.findElement(By.cssSelector("td.big2")).getText(), "rolepreserved");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
