...
public class REGPH1012SettingswithpasswordpolicyAvoidAmbiguousSymbols {
  ...
  @Test
  public void testREGPH1012SettingswithpasswordpolicyAvoidAmbiguousSymbols() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Checking only symbols in the setting 
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_NewPasswordTextBox")).sendKeys("111111");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_ConfirmNewPasswordTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_ConfirmNewPasswordTextBox")).sendKeys("111111");
