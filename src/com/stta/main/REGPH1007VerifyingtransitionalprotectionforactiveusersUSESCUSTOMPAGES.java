...
public class REGPH1007VerifyingtransitionalprotectionforactiveusersUSESCUSTOMPAGES {
  ...
  @Test
  public void testREGPH1007VerifyingtransitionalprotectionforactiveusersUSESCUSTOMPAGES() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Transitional Protection for Active User1  -Offshore1
    ...
    for (int second = 0;; second++) {
    	...
    	try { if (driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*W1512[\\s\\S]*$")) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }
    ...
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if ("Transitional Protection".equals(driver.findElement(By.linkText("Transitional Protection")).getText())) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//tr[6]/td[2]")).getText(), "True");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//tr[7]/td[2]")).getText(), "31/01/2008 00:00:00");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
