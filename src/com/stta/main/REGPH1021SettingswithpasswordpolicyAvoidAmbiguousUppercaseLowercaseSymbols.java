...
public class REGPH1021SettingswithpasswordpolicyAvoidAmbiguousUppercaseLowercaseSymbols {
  ...
  @Test
  public void testREGPH1021SettingswithpasswordpolicyAvoidAmbiguousUppercaseLowercaseSymbols() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Setting the upper-case, lower-case, symbols in the password policy 
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]* Password incorrect or new password is invalid\\. Your new password should contain lower-case characters, upper-case characters, one of the following symbols: ! @ # \\$ % & [\\s\\S]* + - = [\\s\\S] / ~\\. It should be between 8 and 10 characters in length and it should be different from your previous password\\. [\\s\\S]*$"));
    } catch (Error e) {
