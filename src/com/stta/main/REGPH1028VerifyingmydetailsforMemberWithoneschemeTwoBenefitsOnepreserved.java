...
public class REGPH1028VerifyingmydetailsforMemberWithoneschemeTwoBenefitsOnepreserved {
  ...
  @Test
  public void testREGPH1028VerifyingmydetailsforMemberWithoneschemeTwoBenefitsOnepreserved() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Dynamic Pages _ My Details - 08
    // Author : Harish , Date : 19/05/2008
    // Login as Member With one scheme,two  Benefits - One preserved
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).sendKeys("dynamic06");
    ...
    // ERROR: Caught exception [ERROR: Unsupported command [getTable | //table.7.1 | ]]
    // ERROR: Caught exception [ERROR: Unsupported command [getTable | //table.8.0 | ]]
    // verify The details in about me page are displayed correctly
    driver.findElement(By.linkText("Change account")).click();
    // select the secon account
