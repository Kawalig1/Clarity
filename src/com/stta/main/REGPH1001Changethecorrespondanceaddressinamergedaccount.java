...
public class REGPH1001Changethecorrespondanceaddressinamergedaccount {
  ...
  @Test
  public void testREGPH1001Changethecorrespondanceaddressinamergedaccount() throws Exception {
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder_CorrespondenceAddressLinkButton")).click();
