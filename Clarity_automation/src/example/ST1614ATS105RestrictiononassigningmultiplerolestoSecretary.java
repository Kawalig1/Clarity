...
public class ST1614ATS105RestrictiononassigningmultiplerolestoSecretary {
  ...
  public void testST1614ATS105RestrictiononassigningmultiplerolestoSecretary() throws Exception {
    ...
    try {
    	boolean str1 = driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*There is already an entry in the current list which matches the description you just entered\\. Please ensure that duplicates are not being added and try again\\.[\\s\\S]*$");
