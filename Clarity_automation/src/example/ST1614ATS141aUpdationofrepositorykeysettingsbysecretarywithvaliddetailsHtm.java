...
public class ST1614ATS141aUpdationofrepositorykeysettingsbysecretarywithvaliddetailsHtm {
  ...
  @Test
  public void testST1614ATS141aUpdationofrepositorykeysettingsbysecretarywithvaliddetailsHtm() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // 16.14_ Trustee PIN Generation
    // Repository key settings with valid details
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ConfirmPasswordTextBox")).sendKeys("Password#2");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_NewPasswordTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_NewPasswordTextBox")).sendKeys("Password#2");
