...
public class ST1614ATS160CreateaccountforTrusteeandGovernancewithoutmandatorydetails {
  ...
  @Test
  public void testST1614ATS160CreateaccountforTrusteeandGovernancewithoutmandatorydetails() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description  - Create account for Trustee and Governance without mandatory details
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_AddTrusteeGridView_ctl03_FooterSurNameTextBox")).sendKeys("Surname");
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_AddTrusteeGridView_ctl03_FooterForeNameTextBox")).sendKeys("Forname");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_AddTrusteeGridView_ctl03_FooterAddNewLinkButton")).click();
    Thread.sleep(1000);
    // Warning: verifyTextPresent may require manual changes
    try {
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_AddTrusteeGridView_ctl04_FooterForeNameTextBox")).sendKeys("Forname");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_AddTrusteeGridView_ctl04_FooterSurNameTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_AddTrusteeGridView_ctl04_FooterSurNameTextBox")).sendKeys("surname");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_AddTrusteeGridView_ctl04_FooterAddNewLinkButton")).click();
    Thread.sleep(1000);
    /* Warning: verifyTextPresent may require manual changes
   try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Please enter a valid title\\.[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }*/
