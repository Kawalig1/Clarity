...
public class Scenario2ST1605ATS006EditaPrivateentryUncheckPrivatecheckbox {
  ...
  @Test
  public void testScenario2ST1605ATS006EditaPrivateentryUncheckPrivatecheckbox() throws Exception {
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder_EventFormView_TitleTextBox")).sendKeys("test1");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_EventFormView_DescriptionTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_EventFormView_DescriptionTextBox")).sendKeys("test1");
