...
public class ST1614ATS153CreateaddressforGovernancewithaddressnamealreadyexist {
  ...
  @Test
  public void testST1614ATS153CreateaddressforGovernancewithaddressnamealreadyexist() throws Exception {
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_TrusteeAddressDetailsView_txtAddressName")).sendKeys("GovernanceAddress2");
