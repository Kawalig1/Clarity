...
public class ST1614ATS131ResetdatainChangePasswordpage {
  ...
  @Test
  public void testST1614ATS131ResetdatainChangePasswordpage() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description  - Reset password in change password page
    ...
    // Reset button in Change password page
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_ResetButton")).click();
    try {
      assertEquals(driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_PasswordTextBox")).getText(), "");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertEquals(driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_NewPasswordTextBox")).getText(), "");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertEquals(driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangePasswordControl_ConfirmNewPasswordTextBox")).getText(), "");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
