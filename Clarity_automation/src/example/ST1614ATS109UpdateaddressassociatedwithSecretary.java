...
public class ST1614ATS109UpdateaddressassociatedwithSecretary {
  ...
  @Test
  public void testST1614ATS109UpdateaddressassociatedwithSecretary() throws Exception {
	  Thread.sleep(2000);
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description  -Update address associated with Secretary 
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_LoginGenerationContainer_AdminAddressPanel_TrusteeAddressDetailsView_txtAddressLine4")).sendKeys("AddressLin");
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*AddressLin[\\s\\S]*$"));
    } catch (Error e) {
