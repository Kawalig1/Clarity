...
public class ST1614ATS115CreateaddressforSecretarywithaddressnamealreadyexist {
  ...
  @Test
  public void testST1614ATS115CreateaddressforSecretarywithaddressnamealreadyexist() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description  - Create address for Secretary with address name already exist
    ...
    // ERROR: Caught exception [Error: locator strategy either id or name must be specified explicitly.]
    // ERROR: Caught exception [Error: locator strategy either id or name must be specified explicitly.]
    // Creation of address for Secretary with the address name already exist
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_LoginGenerationContainer_AdminAddressPanel_TrusteeAddressDetailsView_txtAddressLine2")).sendKeys("New");
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_LoginGenerationContainer_AdminAddressPanel_TrusteeAddressDetailsView_txtAddressLine3")).sendKeys("New");
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_LoginGenerationContainer_AdminAddressPanel_TrusteeAddressDetailsView_txtAddressLine4")).sendKeys("New");
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_LoginGenerationContainer_AdminAddressPanel_TrusteeAddressDetailsView_txtAddressCity")).sendKeys("New");
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_LoginGenerationContainer_AdminAddressPanel_TrusteeAddressDetailsView_txtAddressCounty")).sendKeys("New");
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_LoginGenerationContainer_AdminAddressPanel_TrusteeAddressDetailsView_txtAddressCountry")).sendKeys("Address");
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_LoginGenerationContainer_AdminAddressPanel_TrusteeAddressDetailsView_txtAddressPostCode")).sendKeys("Create");
    //driver.findElement(By.linkText("Insert")).click();
    driver.findElement(By.xpath(".//*[@id='ctl00_ContentPlaceHolder1_LoginGenerationContainer_AdminAddressPanel_TrusteeAddressDetailsView']/tbody/tr[10]/td")).click();
    Thread.sleep(5000);
    ...
    try {
     // assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*An address with same name already exists, please rename and try again\\.[\\s\\S]*$"));
      boolean str= (driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*An address with same name already exists, please rename and try again\\.[\\s\\S]*$"));
