...
public class ST1614ATS152CreateaddressforTrusteewithaddressnamealreadyexist {
  ...
  @Test
  public void testST1614ATS152CreateaddressforTrusteewithaddressnamealreadyexist() throws Exception {
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_TrusteeAddressDetailsView_txtAddressName")).sendKeys("TrusteeAddress2");
    Thread.sleep(1000);
