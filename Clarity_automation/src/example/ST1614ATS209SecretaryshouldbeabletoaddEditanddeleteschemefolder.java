...
public class ST1614ATS209SecretaryshouldbeabletoaddEditanddeleteschemefolder {
  ...
  @Test
  public void testST1614ATS209SecretaryshouldbeabletoaddEditanddeleteschemefolder() throws Exception {
   ...
   // driver.findElement(By.linkText("Log In")).click();
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ManageFolderControl_txtFolderName")).sendKeys("sub folder");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ManageFolderControl_txtComments")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ManageFolderControl_txtComments")).sendKeys("sub folder1");
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*sub folder[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    driver.findElement(By.linkText("sub folder")).click();
    Thread.sleep(1000);
    driver.findElement(By.linkText("Edit Folder")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ManageFolderControl_txtFolderName")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ManageFolderControl_txtFolderName")).sendKeys("sub folder1234");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ManageFolderControl_btnOK")).click();
    Thread.sleep(1000);
    driver.findElement(By.xpath("//img[@alt='Expand FrontierScheme2']")).click();
    Thread.sleep(1000);
    ...
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*sub folder1234[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    driver.findElement(By.linkText("sub folder1234")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ViewFilesControl1_btnDeleteFolder")).click();
    Thread.sleep(1000);
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Are you sure you wish to delete this folder[\\s\\S][\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
