...
public class ST1614ATS100Createtrustfromadminsite {
  ...
  public void testST1614ATS100Createtrustfromadminsite() throws Exception {
    ...
    try {
    	 ...
    	 boolean str =(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Trusts[\\s\\S]*$"));
    ...
    try {
     ...
     boolean str = (driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*16\\.14_Trust auto[\\s\\S]*$"));
     System.out.println("str:"+str);
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
