...
public class ST1614ATS128ResetdatainChangeMemorableWordpage {
  ...
  @Test
  public void testST1614ATS128ResetdatainChangeMemorableWordpage() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description  - Reset memorable word
    ...
    driver.findElement(By.name("UserNameTextBox")).sendKeys("slogin");
    ...
    for (int second = 0;; second++) {
    	...
    	try { if (driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Trust Name[\\s\\S]*$")) break; }
    	catch (Exception e) {
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangeMemorableWordControl_MemorableWordTextBox")).sendKeys("00000000");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangeMemorableWordControl_ConfirmMemorableWordTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangeMemorableWordControl_ConfirmMemorableWordTextBox")).sendKeys("00000000");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_ChangeMemorableWordControl_ResetButton")).click();
