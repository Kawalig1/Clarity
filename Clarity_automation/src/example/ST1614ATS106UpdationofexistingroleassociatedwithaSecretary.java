...
public class ST1614ATS106UpdationofexistingroleassociatedwithaSecretary {
  ...
  @Test
  public void testST1614ATS106UpdationofexistingroleassociatedwithaSecretary() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description -  Update existing role associated with the secretary
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Training, User1[\\s\\S]*$"));
    } catch (Error e) {
