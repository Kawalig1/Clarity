...
public class ST1614ATS107Restrictiononrolecreationforsecretarywithsamedetails {
  ...
  @Test
  public void testST1614ATS107Restrictiononrolecreationforsecretarywithsamedetails() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description -Restriction on role creation for secretary with same details
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_RoleDetailsView_txtEditRoleName")).sendKeys("Role2");
