...
public class ST1614ATS199ForgotpasswordwithwronganswerandforgotmemorableworduncheckedNOLONGERAPPLICABLE {
  ...
  @Test
  public void testST1614ATS199ForgotpasswordwithwronganswerandforgotmemorableworduncheckedNOLONGERAPPLICABLE() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description  - Trustee forgot password with wrong answer and forgot memorable word unchecked
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Your answer is incorrect or your new password is invalid\\. Your new password should contain numbers, lower-case characters, upper-case characters, symbols, 8 to 15 characters \\(inclusive\\); and it should be different from your previous password\\.[\\s\\S]*$"));
    } catch (Error e) {
