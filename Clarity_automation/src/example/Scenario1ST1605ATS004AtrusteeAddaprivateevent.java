...
public class Scenario1ST1605ATS004AtrusteeAddaprivateevent {
  ...
  @Test
  public void testScenario1ST1605ATS004AtrusteeAddaprivateevent() throws Exception {
	  Thread.sleep(5000);
   ...
   // driver.findElement(By.xpath("//a[2]")).click();
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder_EventFormView_TitleTextBox")).sendKeys("testing auto");
    ...
    driver.findElement(By.linkText("testing auto")).click();
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*testing auto Private[\\s\\S]*$"));
    } catch (Error e) {
