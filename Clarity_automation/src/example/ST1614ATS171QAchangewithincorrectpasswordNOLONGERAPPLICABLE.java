...
public class ST1614ATS171QAchangewithincorrectpasswordNOLONGERAPPLICABLE {
  ...
  @Test
  public void testST1614ATS171QAchangewithincorrectpasswordNOLONGERAPPLICABLE() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description  - Governance change Question and Answer with invalid password
  ...
  //driver.findElement(By.linkText("Options")).click();
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder_ChangeQuestionAnswer1_PasswordTextBox")).sendKeys("passwor");
