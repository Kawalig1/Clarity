...
public class ST1614ATS201UncheckforgotpasswordandforgotmemorablewordNOLONGERAPPLICABLE {
  ...
  @Test
  public void testST1614ATS201UncheckforgotpasswordandforgotmemorablewordNOLONGERAPPLICABLE() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description  -Trustee uncheck forgot password and forgot memorable word
    // admin log into the admin site
    driver.get("http://clarity/pages/static/login.aspx");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).sendKeys("g4governanc");
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Please Check any of the Check Boxes[\\s\\S]*$"));
    } catch (Error e) {
