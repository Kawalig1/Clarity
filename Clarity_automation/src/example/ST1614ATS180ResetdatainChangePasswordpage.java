...
public class ST1614ATS180ResetdatainChangePasswordpage {
  ...
  @Test
  public void testST1614ATS180ResetdatainChangePasswordpage() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 120000 | ]]
    // Story 16.14 - Trustee PIN Generation
    // Prepared by - Yusoof - Date - 13/12/2008
    // Description  -Trustee/Governance user reseting Change password page
  ...
  //driver.findElement(By.linkText("Options")).click();
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder_ChangePassword1_NewPasswordTextBox")).sendKeys("12345678");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_ChangePassword1_ConfirmNewPasswordTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_ChangePassword1_ConfirmNewPasswordTextBox")).sendKeys("12345678");
