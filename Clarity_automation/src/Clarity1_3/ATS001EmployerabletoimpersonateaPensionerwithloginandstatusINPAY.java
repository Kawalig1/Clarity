...
public class ATS001EmployerabletoimpersonateaPensionerwithloginandstatusINPAY {
  ...
  @Test
  public void test0207ATS001EmployerabletoimpersonateaPensionerwithloginandstatusINPAY() throws Exception {
    ...
    driver.findElement(By.id("ctl00_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_MemberDetailsRadioButton")).click();
    new Select(driver.findElement(By.id("ctl00_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_MemberStatusDropDownList"))).selectByVisibleText("PROPAY In Pay Pensioner");
    driver.findElement(By.id("ctl00_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SearchButton")).click();
    Thread.sleep(1000);
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*PensionerAccountMerge[\\s\\S]*$"));
    } catch (Error e) {
  ...
  //Click on My Details
    ...
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*02\\.08\\.42[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Warning: assertTextPresent may require manual changes
