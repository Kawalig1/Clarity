...
public class ATS006VerifyPensionerabletoviewtheirHomepage {
  ...
  @Test
  public void test0204ATS006VerifyPensionerabletoviewtheirHomepage() throws Exception {
    ...
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Your pension[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Warning: assertTextPresent may require manual changes
    try{
    assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*We paid you £0.00 on 01/01/0001 after tax\\. Your pension before tax was £0.00 \\ More details[\\s\\S]*$"));
    }catch(Error e){
    	verificationErrors.append(e.toString());
    }
    // Warning: verifyTextPresent may require manual changes
