...
public class ATS018VerifyClaritydisplayanerrormessageifmemberentersaninvalidtelephonenumber {
  ...
  @Test
  public void test1501ATS018VerifyClaritydisplayanerrormessageifmemberentersaninvalidtelephonenumber() throws Exception {
    ...
    Thread.sleep(1000);
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_grdSwitchStep1']/tbody/tr[2]/td[1]")).getText(), "Contribution Fund D");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_GridView1']/tbody/tr[2]/td[1]")).getText(), "Contribution Fund D");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_GridView1']/tbody/tr[3]/td[1]")).getText(), "Contribution Fund E");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_grdSwitchStep3']/tbody/tr[2]/td[1]")).getText(), "Contribution Fund A");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_txtTelephone")).clear();
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_txtTelephone")).sendKeys("078578578553");
    Thread.sleep(1000);
    driver.findElement(By.xpath(".//*[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_StepNavigationTemplateContainerID_StepNextLinkButton']")).click();
    Thread.sleep(1000);
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Please enter a valid telephone number\\.[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_txtTelephone")).clear();
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_txtTelephone")).sendKeys("078578");
    Thread.sleep(1000);
    driver.findElement(By.xpath(".//*[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_StepNavigationTemplateContainerID_StepNextLinkButton']")).click();
    Thread.sleep(1000);
    // Warning: verifyTextPresent may require manual changes
    ...
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_txtTelephone")).clear();
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_txtTelephone")).sendKeys("(044)4254254278");
    Thread.sleep(1000);
    driver.findElement(By.xpath(".//*[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_StepNavigationTemplateContainerID_StepNextLinkButton']")).click();
    Thread.sleep(1000);
    // Warning: verifyTextPresent may require manual changes
    ...
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_txtTelephone")).clear();
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_txtTelephone")).sendKeys("(044)42542542");
    Thread.sleep(1000);
    driver.findElement(By.xpath(".//*[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_StepNavigationTemplateContainerID_StepNextLinkButton']")).click();
    Thread.sleep(1000);
    // Warning: assertTextNotPresent may require manual changes
    assertFalse(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*//table\\[@id='ctl00_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard'\\]/tbody/tr\\[1\\]/td/table\\[1\\]\\.1\\.2[\\s\\S]*$"));
