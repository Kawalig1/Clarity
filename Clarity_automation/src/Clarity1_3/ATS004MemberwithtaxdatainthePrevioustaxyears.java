...
public class ATS004MemberwithtaxdatainthePrevioustaxyears {
  ...
  @Test
  public void test0202ATS004MemberwithtaxdatainthePrevioustaxyears() throws Exception {
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_dvInfoOnP60']/tbody/tr[2]/td[1]")).getText(), "Employer name");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_dvInfoOnP60']/tbody/tr[2]/td[2]")).getText(), "02.08Empolyer");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_dvInfoOnP60']/tbody/tr[3]/td[1]")).getText(), "Employer PAYE reference");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertEquals(driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_dvInfoOnP60_employerPAYErefTaxDis")).getText(), "123 /");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_dvInfoOnP60']/tbody/tr[4]/td[1]")).getText(), "Payroll reference");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_dvInfoOnP60']/tbody/tr[4]/td[2]")).getText(), "02.08.09");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    try {
      assertEquals(driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_dvInfoOnP60_finalTaxBasisLabel")).getText(), "");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    try {
      //assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_fvInfoOnP60Tax']/tbody/tr[2]/td[2]")).getText(), "£2,000.00");
    ...
    try {
      //assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_fvInfoOnP60Tax']/tbody/tr[2]/td[3]")).getText(), "£2,000.00");
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_fvInfoOnP60Tax']/tbody/tr[3]/td[1]")).getText(), "Previous employment");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
    ...
    try {
      assertEquals(driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_fvInfoOnP60Tax_previousEmpTaxLabel")).getText(), "£0.00");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertEquals(driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_fvInfoOnP60Tax_totalForYearLabel")).getText(), "Total for year");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      //assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_fvInfoOnP60Tax']/tbody/tr[4]/td[2]")).getText(), "£2,000.00");
