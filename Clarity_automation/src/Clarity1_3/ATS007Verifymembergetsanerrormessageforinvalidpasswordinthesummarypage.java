...
public class ATS007Verifymembergetsanerrormessageforinvalidpasswordinthesummarypage {
  ...
  @Test
  public void test1501ATS007Verifymembergetsanerrormessageforinvalidpasswordinthesummarypage() throws Exception {
    ...
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_txtPassword")).sendKeys("password234");
    Thread.sleep(1000);
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_StepNavigationTemplateContainerID_StepNextLinkButton")).click();
    Thread.sleep(1000);
