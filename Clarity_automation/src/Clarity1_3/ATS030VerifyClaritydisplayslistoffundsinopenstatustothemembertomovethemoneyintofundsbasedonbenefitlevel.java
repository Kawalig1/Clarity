...
public class ATS030VerifyClaritydisplayslistoffundsinopenstatustothemembertomovethemoneyintofundsbasedonbenefitlevel {
  ...
  @Test
  public void test1501ATS030VerifyClaritydisplayslistoffundsinopenstatustothemembertomovethemoneyintofundsbasedonbenefitlevel() throws Exception {
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_grdSwitchSelect']/tbody/tr[4]/td[2]")).getText(), "Contribution Fund F");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_grdSwitchSelect']/tbody/tr[5]/td[2]")).getText(), "Contribution Fund G");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    //try {
    //  assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_grdSwitchSelect']/tbody/tr[6]/td[2]")).getText(), "Contribution Fund A");
    //} catch (Error e) {
    //  verificationErrors.append(e.toString());
    //}
    //try {
    //  assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_grdSwitchSelect']/tbody/tr[7]/td[2]")).getText(), "Contribution Fund B");
    //} catch (Error e) {
    //  verificationErrors.append(e.toString());
    //}
    //try {
      //assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_grdSwitchSelect']/tbody/tr[8]/td[2]")).getText(), "Contribution Fund C");
    //} catch (Error e) {
      //verificationErrors.append(e.toString());
    //}
