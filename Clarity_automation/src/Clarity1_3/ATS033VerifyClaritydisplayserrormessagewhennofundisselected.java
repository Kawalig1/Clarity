...
public class ATS033VerifyClaritydisplayserrormessagewhennofundisselected {
  ...
  @Test
  public void test1501ATS033VerifyClaritydisplayserrormessagewhennofundisselected() throws Exception {
    ...
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_StepNavigationTemplateContainerID_StepNextLinkButton")).click();
    assertEquals(driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_lblErrorStep3")).getText(), "You must select at least one fund.");
