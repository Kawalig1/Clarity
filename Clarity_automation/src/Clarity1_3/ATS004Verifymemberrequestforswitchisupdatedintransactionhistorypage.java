...
public class ATS004Verifymemberrequestforswitchisupdatedintransactionhistorypage {
  ...
  @Test
  public void test10003ATS004Verifymemberrequestforswitchisupdatedintransactionhistorypage() throws Exception {
    ...
    Thread.sleep(1000);
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_AdminContainer_TSTabPanel_gvTransactionTypes_ctl04_btnEdit")).click();
    Thread.sleep(1000);
    new Select(driver.findElement(By.id("ctl00_ContentPlaceHolder1_AdminContainer_TSTabPanel_gvTransactionTypes_ctl04_ddlFullTransRequestType"))).selectByVisibleText("None");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_AdminContainer_TSTabPanel_gvTransactionTypes_ctl04_btnUpdate")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("ctl00_MenuTreeViewn1")).click();
    Thread.sleep(1000);
    driver.get("http://Clarity/Pages/Static/Login.aspx");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).sendKeys("CAA");
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*SwitchRequest[\\s\\S]*$"));
    } catch (Error e) {
