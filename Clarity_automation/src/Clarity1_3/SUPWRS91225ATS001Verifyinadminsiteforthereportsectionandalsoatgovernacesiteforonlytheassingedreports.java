...
public class SUPWRS91225ATS001Verifyinadminsiteforthereportsectionandalsoatgovernacesiteforonlytheassingedreports {
  ...
  @Test
  public void testSUPWRS91225ATS001Verifyinadminsiteforthereportsectionandalsoatgovernacesiteforonlytheassingedreports() throws Exception {
    ...
    Thread.sleep(1000);
    new Select(driver.findElement(By.id("ctl00_ContentPlaceHolder1_drpRoles"))).selectByVisibleText("Per_gov");
    Thread.sleep(1000);
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).sendKeys("PReport");
