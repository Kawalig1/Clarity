...
public class ATS0091VerifymemberwithlifestylefundwhohasAVCcontributiontypeabletoprocessswitch {
  ...
  @Test
  public void test1502ATS0091VerifymemberwithlifestylefundwhohasAVCcontributiontypeabletoprocessswitch() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 60000 | ]]
    driver.get("http://clarity/pages/static/Login.aspx");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).sendKeys("SWLF4");
    ...
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_StepNavigationTemplateContainerID_StepNextLinkButton")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_chkStep3Row1")).click();
    ...
    Thread.sleep(1000);
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard']/tbody/tr[1]/td/h1")).getText(), "Confirmation");
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Thank you for your instructions. The transfer will take place according to timescales agreed by the trustees, scheme administrator and fund managers. We will let you know when the AVCs switch has been completed[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    ...
    try {
      assertFalse(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*id=ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_pnlLifeStyle[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Warning: verifyTextNotPresent may require manual changes
