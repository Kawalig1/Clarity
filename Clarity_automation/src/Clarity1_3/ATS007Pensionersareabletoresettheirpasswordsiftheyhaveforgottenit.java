...
public class ATS007Pensionersareabletoresettheirpasswordsiftheyhaveforgottenit {
  ...
  @Test
  public void test0208ATS007Pensionersareabletoresettheirpasswordsiftheyhaveforgottenit() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 60000 | ]]
    driver.get("http://clarity/Pages/Static/Login.aspx");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).sendKeys("FRTPWD1");
