...
public class ATS008VerifymemberisabletorequestanewswitchfornonAVCwhenanexistingswitchisoutstandingforAVCwhichwascreatedinoPen {
  ...
  @Test
  public void test1502ATS008VerifymemberisabletorequestanewswitchfornonAVCwhenanexistingswitchisoutstandingforAVCwhichwascreatedinoPen() throws Exception {
    ...
    Thread.sleep(1000);
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard']/tbody/tr[1]/td/p[2]")).getText(), "Total current value to be moved so far: £523.52");
    } catch (Error e) {
    ...
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_StepNavigationTemplateContainerID_StepNextLinkButton")).click();
    Thread.sleep(1000);
    // ERROR: Caught exception [ERROR: Unsupported command [clickAt | link=Move money between funds | ]]
