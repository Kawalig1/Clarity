...
public class ATS035VerifyClaritydisplaysonlytheNonAVCallocationsinthesummarypage {
  ...
  @Test
  public void test1501ATS035VerifyClaritydisplaysonlytheNonAVCallocationsinthesummarypage() throws Exception {
    ...
    try {
      assertFalse(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Percentage of AVC[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    ...
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_grdSwitchStep2_ctl03_txtnormalval")).sendKeys("60");
    Thread.sleep(1000);
    driver.findElement(By.id("ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard_StepNavigationTemplateContainerID_StepNextLinkButton")).click();
    Thread.sleep(1000);
    // Warning: verifyTextNotPresent may require manual changes
