...
public class ATS015Verifyifthepercentagevaluesenteredinstep3areretainedwhenclickingbackfromstep3andproceedingagain {
  ...
  @Test
  public void test1501ATS015Verifyifthepercentagevaluesenteredinstep3areretainedwhenclickingbackfromstep3andproceedingagain() throws Exception {
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*All your AVC contribution have been invested\\.[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*All your normal contributions have been invested\\.[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
