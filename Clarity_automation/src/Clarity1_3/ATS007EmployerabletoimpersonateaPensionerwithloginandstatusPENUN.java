...
public class ATS007EmployerabletoimpersonateaPensionerwithloginandstatusPENUN {
  ...
  @Test
  public void test0207ATS007EmployerabletoimpersonateaPensionerwithloginandstatusPENUN() throws Exception {
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*PensionerDevEightteen[\\s\\S]*$"));
    } catch (Error e) {
