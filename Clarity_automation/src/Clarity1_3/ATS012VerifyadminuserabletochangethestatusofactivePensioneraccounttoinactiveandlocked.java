...
public class ATS012VerifyadminuserabletochangethestatusofactivePensioneraccounttoinactiveandlocked {
  ...
  @Test
  public void test10005ATS012VerifyadminuserabletochangethestatusofactivePensioneraccounttoinactiveandlocked() throws Exception {
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Pensioner[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    driver.findElement(By.xpath(".//*[@id='ctl00_ctl00_BaseContentPlaceHolder_LoginStatus']")).click();
    Thread.sleep(1000);
    ...
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_AdminContainer_FilterPanel_txtSurname")).sendKeys("PensionerLoginactive");
    Thread.sleep(1000);
    ...
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*PensionerLoginactive[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
