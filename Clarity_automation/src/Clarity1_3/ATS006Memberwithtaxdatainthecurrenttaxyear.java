...
public class ATS006Memberwithtaxdatainthecurrenttaxyear {
  ...
  @Test
  public void test0202ATS006Memberwithtaxdatainthecurrenttaxyear() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 60000 | ]]
    driver.get("http://clarity/Pages/Static/Login.aspx");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).sendKeys("02.08.19");
    ...
    try {
      ...
      try {
          assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*02.08.19[\\s\\S]*$"));
        } catch (Error e) {
          verificationErrors.append(e.toString());
        }
    ...
    assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_fvInfoOnP60Tax']/tbody/tr[2]/td[1]")).getText(), "This employment");
    try {
