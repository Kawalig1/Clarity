...
public class ATS010MemberwithBothAVCandNonAVCunprocessedswitches {
  ...
  @Test
  public void test1502ATS010MemberwithBothAVCandNonAVCunprocessedswitches() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 60000 | ]]
    driver.get("http://clarity/pages/static/Login.aspx");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).sendKeys("SWQ");
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Total current value to be moved so far: £1,065.35[\\s\\S]*$"));
    } catch (Error e) {
    ...
    Thread.sleep(1000);
    driver.findElement(By.linkText("What does the scheme provide?")).click();
    Thread.sleep(1000);
