...
public class ATS003VerifymemberisnotabletoprocessanewswitchwhenanexistingswitchisoutstandingwhichwascreatedinoPenforAVCcontributiontype {
  ...
  @Test
  public void test1502ATS003VerifymemberisnotabletoprocessanewswitchwhenanexistingswitchisoutstandingwhichwascreatedinoPenforAVCcontributiontype() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 60000 | ]]
	driver.get("http://clarity/Pages/Static/Login.aspx");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).sendKeys("swi");
    ...
    Thread.sleep(1000);
    try {
      assertEquals(driver.findElement(By.xpath("//table[@id='ctl01_ctl00_BaseContentPlaceHolder_ContentPlaceHolder_SwitchWizard']/tbody/tr[1]/td/h1[1]")).getText(), "Step 1 of 4");
    } catch (Error e) {
    ...
    //try {
      //assertFalse(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*SwitchFund C[\\s\\S]*$"));
    //} catch (Error e) {
      //verificationErrors.append(e.toString());
    //}
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*The current value is based on the unit price as at date shown in the 'Valued at' field for each fund.[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
