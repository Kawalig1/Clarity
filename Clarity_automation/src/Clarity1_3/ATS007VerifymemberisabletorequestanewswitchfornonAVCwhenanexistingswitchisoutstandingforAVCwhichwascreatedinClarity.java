...
public class ATS007VerifymemberisabletorequestanewswitchfornonAVCwhenanexistingswitchisoutstandingforAVCwhichwascreatedinClarity {
  ...
  @Test
  public void test1502ATS007VerifymemberisabletorequestanewswitchfornonAVCwhenanexistingswitchisoutstandingforAVCwhichwascreatedinClarity() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 60000 | ]]
    driver.get("http://Clarity/pages/static/login.aspx");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).sendKeys("swo");
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Which funds would you like to move money out of[\\s\\S][\\s\\S]*$"));
    } catch (Error e) {
    ...
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*SwitchFund F[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Warning: verifyTextPresent may require manual changes
