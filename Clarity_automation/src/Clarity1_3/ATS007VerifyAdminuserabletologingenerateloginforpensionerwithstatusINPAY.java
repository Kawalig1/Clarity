...
public class ATS007VerifyAdminuserabletologingenerateloginforpensionerwithstatusINPAY {
  ...
  @Test
  public void test10005ATS007VerifyAdminuserabletologingenerateloginforpensionerwithstatusINPAY() throws Exception {
    ...
    new Select(driver.findElement(By.id("ctl00_ContentPlaceHolder1_drpPinGenerationMemberStatus"))).selectByVisibleText("In Payment");
    driver.findElement(By.id("ctl00_ContentPlaceHolder1_lnkPinGenerationFilter")).click();
    Thread.sleep(1000);
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*PensionerDevTwentytwo[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*PensionerDevTwentythree[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*PensionerBulkLoginOne[\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
