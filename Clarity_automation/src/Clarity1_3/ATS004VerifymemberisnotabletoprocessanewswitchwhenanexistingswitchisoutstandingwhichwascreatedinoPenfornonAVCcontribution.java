...
public class ATS004VerifymemberisnotabletoprocessanewswitchwhenanexistingswitchisoutstandingwhichwascreatedinoPenfornonAVCcontribution {
  ...
  @Test
  public void test1502ATS004VerifymemberisnotabletoprocessanewswitchwhenanexistingswitchisoutstandingwhichwascreatedinoPenfornonAVCcontribution() throws Exception {
    // ERROR: Caught exception [ERROR: Unsupported command [setTimeout | 60000 | ]]
    driver.get("http://Clarity/pages/static/login.aspx");
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).clear();
    driver.findElement(By.id("ctl00_ContentPlaceHolder_UserNameTextBox")).sendKeys("swj");
    ...
    // Warning: verifyTextPresent may require manual changes
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*How much would you like to move out of each fund?[\\s\\S][\\s\\S]*$"));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
